...
The dataset contains the passengers class, name, survival status, sex, age, number of siblings or spouses aboard, number of parents or children aboard, ticket number, passenger fare, cabin that they stayed in, and the port of embarkation. There are 1309 passangers in total, 466 are female and 843 are male, 809 death and 500 survival. 
